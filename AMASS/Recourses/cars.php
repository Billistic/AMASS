			...
			<div class="container">
				...
				<nav>
					<ul>
						...
						<li><a href="services.html">Track</a></li>
						<?php 
							...
							if($reference!=null){
									...
									if($vehicleStamp==null){
										...
										foreach($vehicleStamp as $x){
											$vehicleRef = $database->getReference('data/users/'.$uid.'/Vehicles/'.$x);
											echo 	'<tr>
														<td class="text-left">'.$vehicleRef->getChild('Registration')->getValue().'</td>
														<td class="text-left">'.$vehicleRef->getChild('Longitude')->getValue().'</td>
														<td class="text-left">'.$vehicleRef->getChild('Latitude')->getValue().'</td>
													</tr>';
										}
									}
							}
